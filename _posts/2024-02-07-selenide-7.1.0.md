...
> NB! New method `$.is(.., Duration.ofSeconds(8))` _can be slow_! In case of `false` result, it will always take _8_!
This is a deadly long time for tests. Try not to use such terms.
...
<center>
  <img src="{{ BASE_PATH }}/images/2024/01/selenide.downloads.png" width="800"/>
</center>
