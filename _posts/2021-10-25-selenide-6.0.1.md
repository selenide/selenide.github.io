...
<br>
# Other news
* Aerokube released [alternative WebDriver client](https://github.com/aerokube/lightning-java). In theory,  Теоретически теперь селенид может работать на нём вместо Selenium Webdriver. Звучит заманчиво? 
