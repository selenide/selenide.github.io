<div class="main-menu">
  ...
  {% if page.show_news %}
    <div class="news">
      <div class="news-line news-title"><a href="/2023/09/28/selenide-6.19.0/">Released Selenide 6.19.0</a></div>
      <div class="news-line news-link">Highlight the invisible</div>
    </div>
  {% endif %}
