<div class="main-menu">
  ...
  {% if page.show_news %}
    <div class="news">
      <div class="news-line news-title"><a href="/2023/08/02/selenide-6.17.0/">Released Selenide 6.17.0</a></div>
      <div class="news-line news-link">Goodbye, WebDriverManager!</div>
    </div>
  {% endif %}
