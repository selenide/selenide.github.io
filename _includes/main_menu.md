<div class="main-menu">
  ...
  {% if page.show_news %}
    <div class="news">
      <div class="news-line news-title"><a href="/2026/04/10/selenide-7.16.0/">Released Selenide {{site.SELENIDE_VERSION}}</a></div>
      <div class="news-line news-link">Selenide MCP server</div>
    </div>
  {% endif %}
