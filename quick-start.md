...
header-text: >
  ...
  Just add <a href="https://search.maven.org/remotecontent?filepath=com/codeborne/selenide/5.2.3/selenide-5.2.3.jar">selenide.jar</a> to your project and you are done.<br/>
