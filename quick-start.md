...
header-text: >
  ...
  Just add <a href="https://search.maven.org/remotecontent?filepath=com/codeborne/selenide/5.0.1/selenide-5.0.1.jar">selenide.jar</a> to your project and you are done.<br/>
