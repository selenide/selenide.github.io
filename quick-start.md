...
header-text: >
  ...
  Just add <a href="https://search.maven.org/remotecontent?filepath=com/codeborne/selenide/5.13.1/selenide-5.13.1.jar">selenide.jar</a> (and its dependencies) to your project and you are done.<br/>
