...
header-text: >
  ...
  Just add <a href="https://search.maven.org/remotecontent?filepath=com/codeborne/selenide/6.9.0/selenide-6.9.0.jar">selenide.jar</a> (and its dependencies) to your project and you are done.<br/>
