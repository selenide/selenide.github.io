...
header-text: >
  ...
  Just add <a href="https://search.maven.org/remotecontent?filepath=com/codeborne/selenide/7.0.4/selenide-7.0.4.jar">selenide.jar</a> (and its dependencies) to your project and you are done.<br/>
