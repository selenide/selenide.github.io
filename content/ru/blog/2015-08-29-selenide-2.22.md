...
* [Переход на Java 7](#upgrade-java-7)
* [Обновились на Selenium 2.47.1](#upgrade-selenium-2.47.1)
* [Исправлена проблема с незакрывающимися браузерами](#fix-unclosed-browsers)
* [Selenide приняли на SeleniumConf 2015](#thank-you-seleniumconf)
* [Новости](#news-links)
...
# Спасибо за вашу помощь! {#thank-you-seleniumconf}
