...
* [Исправили метод `$$().find()`](#fix-find-error-message)
* [Поля ПО `SelenideElement` без аннотации `@FindBy`](#page-object-fields-without-findby)
* [Привели в порядок названия настроек](#align-system-property-names)
* [Задепрекячили `Selenide.selectRadio`](#deprecate-select-radio)
* [Ссылка на свежий Javadoc](#latest-javadoc-link)
* [Обновили зависимости](#upgraded-dependencies)
* [Новости](#news)
* [SeleniumCamp!](#seleniumcamp)
...
# Исправили поля ПО `SelenideElement` без аннотации `@FindBy` {#page-object-fields-without-findby}
...
# Задепрекячили метод `Selenide.selectRadio` {#deprecate-select-radio}
...
# Создали ссылку на свежий Javadoc {#latest-javadoc-link}
