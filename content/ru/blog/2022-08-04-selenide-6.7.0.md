...
description: ""
category:
headerText: "Полные тексты, полные скриншоты"
tags: []
---
<br>
...
* [`$.shouldHave(text)` теперь проверяет текст целиком](#holy-whole-string)
* [Большие скриншоты](#full-size-screenshots)
* [Кэширование элементов в пэдж обжектах](#cache-lookup-annotation)
...
* [Валидация расширения файла](#validate-file-extension)
