...
description: ""
category:
headerText: "Скачивай меня нежно"
tags: []
---
Приветос!
...
* [Новая настройка `Configuration.downloadsFolder`](#add-downloads-folder-setting)
* [Скачивание файлов в `Configuration.downloadsFolder` вместо `~/Downloads`](#download-to-downloads-folder)
* [Переключение между окнами с кастомным таймаутом](#switch-window-with-timeout)
* [Логирование атрибута "readonly"](#log-readonly-attribute)
* [Исправили `IndexOutOfBoundsException`](#fix-index-out-of-bounds)
* [Пачка улучшений скриншотов](#screenshot-improvements)
* [Обновились на WebDriverManager 3.8.1](#upgrade-webdrivermanager)
* [SeleniumCamp 2020](#seleniumcamp-2020)
* [Митап про Селенид в Германии](#selenide-meetup-germany)
* [Статистика](#downloads-statistics)

## Мы добавили новую настройку `Configuration.downloadsFolder` {#add-downloads-folder-setting}
...
### Скачиваем файлы в `Configuration.downloadsFolder` вместо `~/Downloads` {#download-to-downloads-folder}
...
### Добавили метод для переключения между окнами с кастомным таймаутом {#switch-window-with-timeout}
...
### Добавили логирование атрибута "readonly" {#log-readonly-attribute}
...
### Исправили ошибку IndexOutOfBoundsException  {#fix-index-out-of-bounds}
...
### И целая пачка улучшений скриншотов {#screenshot-improvements}
