...
description: ""
category:
headerText: "Залогируй меня, если сможешь"
tags: []
---
...
* [Метод `SelenideLogger.beforeEvent()`](#add-before-event-method)
* [Открыть пустую страницу](#open-blank-page)
* [Рефакторинг: `Condition` в отдельных классах](#refactor-condition-classes)
* [Обновлённые зависимости](#updated-dependencies)
...
# Добавили метод `SelenideLogger.beforeEvent()` {#add-before-event-method}
...
# Теперь можно открывать пустую страницу {#open-blank-page}
...
# Рефакторинг: вынесли все `Condition` в отдельные классы {#refactor-condition-classes}
