---
slug: "selenide-2.25"
date: 2015-11-30T09:00:00
title: "Изменения в Selenide 2.25"
description: ""
category:
headerText: "последний из 2.*"
tags: []
---
Привет!
...
* [Профайлер Selenide для TestNG](#testng-profiler)
* [Методы `$$.first()` и `$$.last()`](#first-last)
* [Метод `Screenshots.getLastScreenshot()`](#get-last-screenshot)
* [`confirm()` и `dismiss()` без параметров](#confirm-dismiss-no-params)
* [Параметр `-Dselenide.reopenBrowserOnFail`](#reopen-browser-on-fail)
* [Обновление до htmlunit 2.19](#htmlunit-2.19)
* [Смена лицензии на MIT](#mit-license)
* [Новости](#news)

## Добавили "Профайлер Selenide" для TestNG {#testng-profiler}
...
## Добавили методы `$$.first()` и `$$.last()` {#first-last}
...
## Добавили метод `Screenshots.getLastScreenshot()` {#get-last-screenshot}
...
## Добавили метод `Selenide.confirm()` и `Selenide.dismiss()` без параметров {#confirm-dismiss-no-params}
...
## Добавили параметр `-Dselenide.reopenBrowserOnFail` {#reopen-browser-on-fail}
