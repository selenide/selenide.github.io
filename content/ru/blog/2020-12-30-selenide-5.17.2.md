---
slug: "selenide-5.17.2"
date: 2020-12-30
title: "Вышла Selenide 5.17.2"
description: ""
category:
headerText: "Последний подарочек"
tags: []
---
Доброе утро!  
...
* [`Commands` возвращают `SelenideElement`](#commands-return-selenideelement)
* [Починили `$.setValue(null)`](#fix-setvalue-null)
* [Soft asserts в `@BeforeAll`/`@AfterAll` (JUnit 5)](#soft-asserts-in-beforeall-afterall)
* [Починили javadoc jar](#fix-javadoc-jar)

<br>

# Теперь `Commands` возвращают `SelenideElement` вместо `WebElement` {#commands-return-selenideelement}
...
# Починили метод `$.setValue(null)` {#fix-setvalue-null}
...
# Включили soft asserts в методах @BeforeAll и @AfterAll (в JUnit 5) {#soft-asserts-in-beforeall-afterall}
...
# Починили файл [selenide-5.17.2-javadoc.jar](https://search.maven.org/remotecontent?filepath=com/codeborne/selenide/5.17.2/selenide-5.17.2-javadoc.jar) 
  теперь он содержит javadoc для всех классов.   {#fix-javadoc-jar}
