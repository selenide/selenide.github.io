...
* [Добавили метод `Selenide.executeAsyncScript()`](#add-execute-async-script)
* [Скачивание файлов без заголовка `Content-Disposition`](#download-without-content-disposition)
* [Исправили метод `WebDriverRunner.using()`](#fix-webdriverrunner-using)
* [Обновились на WebDriverManager 3.8.0](#upgrade-webdrivermanager)
* [Новости](#news)
...
# Научили Selenide скачивать через прокси файлы без заголовка `Content-Disposition` {#download-without-content-disposition}
