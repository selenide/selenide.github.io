...
description: ""
category:
headerText: "Больше настроек богу настроек!"
tags: []
---
<br>
...
* [Поддержка `selenide.properties`](#selenide-properties-file)
* [Тонкая настройка прокси](#fine-tune-proxy)
* [Костыль против `NoClassDefFoundError`](#workaround-noclassdeffounderror)
* [Изменили тип параметра `SelenideConfig.browserCapabilities()`](#browsercapabilities-parameter-type)
* [Обновились на Selenium WebDriver 4.1.0](#upgrade-selenium-webdriver)
* [Удалили `$.shadowRoot()`](#remove-shadow-root)
* [Новости](#news)
* [Статистика скачиваний](#statistics)

<br>

# Добавили поддержку `selenide.properties` {#selenide-properties-file}
...
# Добавили возможность тонкой настройки прокси {#fine-tune-proxy}
...
# Добавили костыль для избежания случайных `NoClassDefFoundError` в `WebDriverException`. {#workaround-noclassdeffounderror}
...
# Поменяли тип параметра `SelenideConfig.browserCapabilities()` {#browsercapabilities-parameter-type}
...
# Удалили метод `$.shadowRoot()` {#remove-shadow-root}
