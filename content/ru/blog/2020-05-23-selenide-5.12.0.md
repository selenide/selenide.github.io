...
description: ""
category:
headerText: "Утерянные капабилити"
tags: []
---
Всем привет!
...
* [Проблема с `Configuration.browserCapabilities`](#fix-browsercapabilities)
* [Отключили диалог "save password?"](#disable-save-password-dialog)
* [Эмуляция мобильника в гриде](#mobile-emulation-in-grid)
* [Упростили сетап Firefox без профиля](#simplify-firefox-setup)
* [`ACCEPT_INSECURE_CERTS` для Edge на Chromium](#accept-insecure-certs-edge)
* [Обновились на WebDriverManager 4.0.0](#upgrade-webdrivermanager)
* [Обновились на browserup-proxy-core 2.1.0](#upgrade-browserup-proxy)
* [Исправили имя папки для скриншота 'emptyMethod'](#fix-screenshot-folder-name)
* [Аннотации `@Nullable` и `@Nonnull`](#nullable-nonnull-annotations)
* [Новости](#news)

## Порешали старинную проблему с `Configuration.browserCapabilities` {#fix-browsercapabilities}
...
## Выключили раздражающий диалог "save password?" {#disable-save-password-dialog}

См. [issue 1133](https://github.com/selenide/selenide/issues/1133) и [PR 1134](https://github.com/selenide/selenide/pull/1134).

## Добавили режим "эмуляции мобильника" в гриде {#mobile-emulation-in-grid}
...
## Упростили сетап Firefox: теперь без профиля {#simplify-firefox-setup}
...
## Задаём настройку `"ACCEPT_INSECURE_CERTS"` для версий Edge, построенных на движке chromium {#accept-insecure-certs-edge}
...
## Расставили аннотации `@Nullable` и `@Nonnull` {#nullable-nonnull-annotations}
