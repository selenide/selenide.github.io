...
description: ""
category:
headerText: "BasicAuth, JBrowser, PhantomJS, TestNG"
tags: []
---
...
* [Вернули стратегию загрузки страницы на `normal`](#revert-page-load-strategy)
* [Пэдж обжекты не обязательно публичные](#page-objects-not-public)
* [Поддержка вебдрайвера JBrowser](#jbrowser-support)
* [`$().download()` использует стандартный таймаут](#download-timeout)
* [Поддержка Basic Auth](#basic-auth-support)
* [Метод `$.screenshotAsImage()`](#method-screenshot-as-image)
* [Починили TestNG TextReport Listener](#fix-testng-textreport-listener)
* [Обновили phantomjsdriver до 1.3.0](#upgrade-phantomjsdriver-1.3.0)
* [Новости](#news)
* [Немного статистики](#statistics)

## Вернули стратегию загрузки страницы обратно на `normal` {#revert-page-load-strategy}
...
см. [issue #321](https://github.com/selenide/selenide/issues/321)

## Теперь пэдж обжекты не обязательно должны быть публичными {#page-objects-not-public}
...
см. [issue #335](https://github.com/selenide/selenide/issues/335)

## Добавлена поддержка вебдрайвера JBrowser {#jbrowser-support}
...
см. [issue #329](https://github.com/selenide/selenide/issues/329)

Спасибо Anil Kumar Reddy Gaddam за этот pull request!

## Метод $().download() теперь использует стандартный селенидовский таймаут {#download-timeout}

А раньше он мог зависать надолго. Один раз наш билд подвис на два часа на методе $.download()! 

см. [issue #341](https://github.com/selenide/selenide/issues/341)

## Добавлена поддержка Basic Auth для основных браузеров {#basic-auth-support}

Примеры использования можно подсмотреть [здесь](https://github.com/selenide/selenide/blob/master/statics/src/test/java/integration/BasicAuthTest.java):
...
см. [issue #320](https://github.com/selenide/selenide/issues/320)

Спасибо [dimand58](https://github.com/dimand58) за этот pull request!

## Добавили метод `$.screenshotAsImage()` {#method-screenshot-as-image}
...
## Обновили phantomjsdriver до версии 1.3.0 (совместима с selenium-java 2.53.0) {#upgrade-phantomjsdriver-1.3.0}
...
<center>
  <img src="/images/2016/06/selenide.downloads.png" width="800"/>
</center>
