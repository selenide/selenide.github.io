...
description: ""
category:
headerText: "Дешорткатификация $.clear"
tags: []
---
<br>
...
* [Новый плагин `selenide-clear-with-shortcut`](#selenide-clear-with-shortcut)
* [Починили `$.clear()` в Safari](#fix-clear-in-safari)
* [Новые проверки для своего текста](#new-own-test-checks)
* [Метод `$.click()` с таймаутом](#click-timeout)
* [Таймаут для `confirm()`, `dismiss()` и `prompt()`](#modal-timeout)
* [Починили `Driver.executeJavaScript()`](#fix-execute-javascript)
* [Поправили формулировки проверок](#fix-checks-wording)
* [Вернули опции Safari](#restore-safari-options)
* [Починили софт ассерты в TestNG](#fix-testng-soft-asserts)
* [Обновили зависимости](#update-dependencies)
* [Статистика](#statistics)

### Появился новый плагин `selenide-clear-with-shortcut` {#selenide-clear-with-shortcut}
...
### Исправили метод `$.clear()` в Safari {#fix-clear-in-safari}
...
### Новые проверки для текста элемента {#new-own-test-checks}
...
### Добавили метод `$.click()` с таймаутом {#click-timeout}
...
### Добавили таймаут методам `confirm()`, `dismiss()` и `prompt()` {#modal-timeout}
...
### Подправили метод `Driver.executeJavaScript()` {#fix-execute-javascript}
...
### Подправили формулировку некоторых проверок {#fix-checks-wording}
...
### Добавили опции для Safari {#restore-safari-options}
...
### Починили софт ассерты на TestNG {#fix-testng-soft-asserts}
