...
description: ""
category:
headerText: "Загрузка файлов, поддержка селектов, логи вебдрайвера"
tags: []
---
Всем привет!
...
* [Функция `$.uploadFile(File)`](#upload-file)
* [Исправили функцию `$.uploadFromClasspath`](#fix-upload-from-classpath)
* [Функция `$.val()` работает и для селектов](#val-for-selects)
* [Функция `getWebDriverLogs()`](#get-webdriver-logs)
* [Обновились до Selenium 2.42.2 и HtmlUnit 2.15](#upgrade-selenium-2-42-2)

### Добавилась функция $.uploadFile(File) {#upload-file}
...
### Функция $.val("джонни") работает и для селектов {#val-for-selects}
...
### Добавилась функция `getWebDriverLogs()`. {#get-webdriver-logs}
...
### Обновились до [Selenium 2.42.2]({{< selenium-changelog >}}) и [HtmlUnit 2.15](http://htmlunit.sourceforge.net/changes-report.html#a2.15) {#upgrade-selenium-2-42-2}
