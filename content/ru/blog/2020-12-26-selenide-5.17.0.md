---
slug: "selenide-5.17.0"
date: 2020-12-26
title: "Вышла Selenide 5.17.0"
description: ""
category:
headerText: "Ho-ho-ho, Page Objects!"
tags: []
---
Доброй ночи!
...
* [Метод `$.as("name")`](#method-as)
* [Настройки для headless chrome](#headless-chrome-default-options)
* [Починили `ByShadowCss.findElements`](#fix-byshadowcss-findelements)
* [Метод `$.should*` с кастомным таймаутом](#should-with-custom-timeout)
* [Пэдж обжекты](#page-objects)
* [Технологические улучшения](#technical-improvements)
* [Известные проблемы](#known-issues)
* [Итоги](#summary)

<br>

# Добавили метод $.as("name") {#method-as}
...
# Добавили настроек нашему headless chrome {#headless-chrome-default-options}
...
# Добавили метод $.should* с кастомным таймаутом {#should-with-custom-timeout}
...
# И напоследок пачка технологических улучшений: {#technical-improvements}
