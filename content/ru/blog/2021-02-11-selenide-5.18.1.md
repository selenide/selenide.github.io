---
slug: "selenide-5.18.1"
date: 2021-02-11
title: "Вышла Selenide 5.18.1"
description: ""
category:
headerText: "Локалхост - нежная штучка!"
tags: []
---
Всем привет!  
...
* [Добавили метод `Selenide.getSessionStorage()`](#method-getsessionstorage)
* [Исправили сообщение об ошибке для `$$.filterBy(and(..))`](#fix-filterby-and-error-message)
* [Передаём настройку "noproxy" селенидовскому прокси](#pass-noproxy-option)
* [Обновились на Netty и LittleProxy](#update-dependencies)
* [Читальня](#reading-list)
...
# Передаём настройку "noproxy" от внешнего прокси селенидовскому {#pass-noproxy-option}
...
# Обновились на Netty 4.1.59.Final и LittleProxy 2.0.2 {#update-dependencies}
