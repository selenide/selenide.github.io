...
description: ""
category:
headerText: "Быстрый $$ и headless на гриде"
tags: []
---
...
* [Метод `$.scrollIntoView()`](#scroll-into-view)
* [Headless браузеры на Selenium Grid](#headless-on-grid)
* [Кастомные capabilities для Chrome и Firefox](#custom-capabilities)
* [Ускорили итерирование `$$`](#optimize-collection-iteration)
* [Заголовок "User-Agent" при скачивании](#user-agent-header)
* [`byText`/`withText` понимают неразрывные пробелы](#unbreakable-spaces)
* [Обновились до phantomjsdriver](#upgrade-phantomjsdriver)
* [Обновились до htmlunit и guava](#upgrade-htmlunit-guava)
* [Новости](#news)

<br>

# Добавили метод `$.scrollIntoView()` {#scroll-into-view}
...
# Теперь можно запускать браузеры _headless_ на гриде {#headless-on-grid}
...
# Теперь можно устанавливать "кастомные капабилити" для Chrome и Firefox {#custom-capabilities}
...
# Мы ускорили итерирование коллекций `$$` {#optimize-collection-iteration}
...
# Добавили заголовок "User-Agent" при скачивании файлов {#user-agent-header}
...
# Теперь методы `byText` и `withText` понимают "неразрывные" пробелы {#unbreakable-spaces}
...
# Обновились до phantomjsdriver 1.4.4 {#upgrade-phantomjsdriver}
...
# Обновились до htmlunit 2.29 и guava:23.6-jre {#upgrade-htmlunit-guava}
