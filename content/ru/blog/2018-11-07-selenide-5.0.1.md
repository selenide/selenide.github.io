...
* [Случайное имя файла при скачивании](#random-file-name)
* [Исправили `IndexOutOfBounds`, когда родитель не найден](#fix-indexoutofbounds-parent-not-found)
* [Исправили `ClassCastException` в `$$.toArray()`](#fix-classcastexception-toarray)
* [Поддержка Chrome 70](#support-chrome-70)
* [Обновились на selenium-java 3.141.5](#upgrade-selenium)
* [Статистика скачиваний](#download-statistics)
* [Конференции](#conferences)

# Генерируем случайное имя файла, если нет никакого {#random-file-name}
...
# Исправили `ClassCastException` в методе `$$.toArray()` {#fix-classcastexception-toarray}
...
# Добавили поддержку chrome 70 {#support-chrome-70}
...
[Список изменений]({{< selenium-changelog >}}) в selenium 3.141.*

<br>

## Статистика {#download-statistics}

Количество скачиваний растёт. Мы пробили планку 40800 скачек в месяц. 

<center>
  <img src="/images/2018/10/selenide-downloads.png" width="800"/>
</center>
