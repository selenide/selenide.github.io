...
description: ""
category:
headerText: "Большой предновогодний рефакторинг"
tags: []
---
Привет!
...
* [Исторический экскурс](#historical-notes)
* [Новые функции в Selenide 3.0](#new-functions)
* [Обновили зависимости](#upgraded-dependencies)
* [Большой рефакторинг](#big-refactoring)
* [Большая чистка](#big-cleanup)
* [Новости](#news)
...
Пример использования [здесь](https://github.com/selenide/selenide/blob/master/src/test/java/integration/UpdateHashTest.java). 
...
Подробнее об этом будет отдельный пост, но пример можно подсмотреть в [тестах самого Selenide](https://github.com/selenide/selenide/tree/master/statics/src/test/java/integration/customcommands).
