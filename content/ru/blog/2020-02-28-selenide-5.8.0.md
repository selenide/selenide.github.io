...
description: ""
category:
headerText: "Псевдо-элементы, псевдо-навигация, псевдо-условия"
tags: []
---
Приветос!
...
* [Свои условия с помощью лямбд](#custom-conditions-lambdas)
* [Методы `$.sibling()` и `$.preceding()`](#sibling-and-preceding)
* [Поддержка псевдо-элементов](#pseudo-elements-support)
* [Исправили `SoftAssertionsExtension` для JUnit5](#fix-soft-assertions-junit5)
* [`$.click()` всегда кликает в ЦЕНТР элемента](#click-center)
* [Новости](#news)

## Упростили создание своих условий с помощью лямбд {#custom-conditions-lambdas}
...
## Добавили методы `$.sibling()` и `$.preceding()` {#sibling-and-preceding}
