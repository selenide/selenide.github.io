...
description: ""
category:
headerText: "Несанкционированный релиз"
tags: []
---
Ура, товарищи!  
...
* [Выключили логи вебдрайвера по умолчанию](#disable-webdriver-logs)
* [Тип параметра "timeout": `Long` на `Duration`](#timeout-type-duration)
* [Ускорили поиск в shadow dom](#speedup-shadow-dom-search)
* [Починили проверки `$.shouldNot(and(...))` и `$.shouldNot(or(...))`](#fix-shouldnot-and-or)
* [Конфликт в настройке "browserName"](#detect-browsername-conflict)
* [Починили показ таймаута в отчёте](#fix-timeout-display-in-reports)
* [Обновились на WebDriverManager 4.3.1](#upgrade-webdrivermanager)
...
# Заменили тип параметра "timeout" с Long на Duration {#timeout-type-duration}
...
# Ускорили поиск вложенных элементов в shadow dom {#speedup-shadow-dom-search}
...
# Исправили проверки `$.shouldNot(and(...))` и `$.shouldNot(or(...))` {#fix-shouldnot-and-or}
...
# Обнаруживаем конфликт в настройке "browserName" {#detect-browsername-conflict}
