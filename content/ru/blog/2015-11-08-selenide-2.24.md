...
description: ""
category:
headerText: "по сусекам поскребли"
tags: []
---
Привет!
...
* [Обновление selenium-java до 2.48.2](#upgrade-to-selenium-2.48.2)
* [Новый метод `$.pressEscape()`](#press-escape)
* [Исправили мягкие ассерты в TestNG](#fix-soft-asserts-testng)
* [WebDriverFactory выделен из WebDriverRunner](#webdriverfactory)
* [Новости](#news)

## Обновились до selenium-java 2.48.2 {#upgrade-to-selenium-2.48.2}

Список [изменений в selenium 2.48.2]({{< selenium-changelog >}}).
...
## Исправили работу мягких ассертов в TestNG {#fix-soft-asserts-testng}
...
## Логику для создания вебдрайвера выделили в отдельный класс WebDriverFactory {#webdriverfactory}
