---
slug: "selenide-2.16-and-2.17"
date: 2015-05-05
title: "Изменения в Selenide 2.16 и 2.17"
description: ""
category:
headerText: "Профайлер, Soft asserts и немного улучшалок"
tags: []
---
Здрасьте!
...
* [Профайлер](#profiler)
* [Исправлена функция `$.closest()`](#fix-closest)
* [Метод `$.toString()` теперь логирует все атрибуты](#tostring-all-attributes)
* [Обновились до Selenium 2.45.0](#upgrade-selenium)
...
### Обновились до [Selenium 2.45.0]({{< selenium-changelog >}}). {#upgrade-selenium}
