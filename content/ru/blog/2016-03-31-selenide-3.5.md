...
description: ""
category:
headerText: "резиновые коллекции"
tags: []
---
Привет!
...
* [Гибкие условия для проверки размера коллекций](#flexible-collection-size-checks)
* [Ускорение загрузки страниц](#page-load-strategy-none)
* [Исправили метод `toString()`](#fixed-tostring)
* [Обновились до selenium-java 2.53.0](#upgrade-selenium-2.53.0)
* [Новости](#news)
* [Немного статистики](#statistics)

## Добавили гибкие условия для проверки размера коллекций {#flexible-collection-size-checks}
...
Список [изменений в selenium 2.53.0]({{< selenium-changelog >}}).
...
<center>
  <img src="/images/2016/03/selenide.downloads.png" width="800"/>
</center>

И количество уникальных IP:
<center>
  <img src="/images/2016/03/selenide.unique-ips.png" width="800"/>
</center>
