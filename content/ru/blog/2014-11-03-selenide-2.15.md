...
description: ""
category:
headerText: "Sizzle селекторы, multifile upload, BrowserMob proxy, zoom, Selenium 2.44.0"
tags: []
---
Здрасьте!
...
* [Sizzle селекторы (CSS3)](#sizzle-selectors)
* [Загрузка многих файлов (multifile upload)](#multifile-upload)
* [Поддержка BrowserMob proxy](#browsermob-proxy)
* [Зум страницы](#zoom-page)
* [Поддержка JSON и iCal](#json-and-ical)
* [Поддержка табов и фреймов по индексу](#tabs-and-windows-by-index)
* [Поддержка Allure Framework](#allure-framework)
* [Обновление до Selenium 2.44.0](#upgrade-selenium-2-44-0)
...
### Теперь можно зумить страницу! {#zoom-page}
...
### Поддержка табов и фреймов {#tabs-and-windows-by-index}
...
### Обновились до [Selenium 2.44.0]({{< selenium-changelog >}}). {#upgrade-selenium-2-44-0}
