...
description: ""
category:
headerText: "Работа с окнами, DragAndDrop, JavaScript ошибки, поиск предков и обновление до Selenium 2.41.0"
tags: []
---
Всем привет!
...
* [Работа с окнами и вкладками](#windows-tabs)
* [Методы `$.hover()` и `$.dragAndDropTo(target)`](#hover-and-drag-and-drop)
* [Методы `$.parent()` и `$.closest()`](#parent-and-closest)
* [Ловля JavaScript ошибок](#tracing-javascript-errors)
* [Закрытие вебдрайверов](#closing-webdrivers)
* [Selenide больше не ждёт `<body>`](#no-wait-for-body)
* [Автоматическое закрытие `alert` при падении теста](#close-alerts-on-failure)
* [Обновление до Selenium 2.41.0](#upgrade-selenium-2-41-0)
* [Статистика загрузок](#download-statistics)

## Новые функции

### Работа с вкладками и окнами {#windows-tabs}
...
### Новые методы для динамики `$.hover()` и `$.dragAndDropTo(target)` {#hover-and-drag-and-drop}
...
### Новые методы для поиска родительских элементов $.parent() и $.closest() {#parent-and-closest}
...
### Selenide больше не ждёт появления &lt;body&gt; {#no-wait-for-body}
...
### Метод savePageSourceToFile пытается закрыть все `alert`. {#close-alerts-on-failure}
...
### Обновились до Selenium 2.41.0 {#upgrade-selenium-2-41-0}
...
## Другие новости {#download-statistics}
...
<center>
<img src="/images/2014/04/selenide_downloads.2014-03.png" width="800"/>
</center>
