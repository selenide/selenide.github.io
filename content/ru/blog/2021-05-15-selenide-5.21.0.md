...
* [Убрали повторные скриншоты для цепочки локаторов](#dedupe-chained-screenshots-report)
* [Добавили `BrowserPerTestStrategyExtension`](#browser-per-test-strategy-extension)
* [Метод `$.hover()` со сдвигом](#hover-with-offset)
* [Обновились на WebDriverManager 4.4.3](#upgrade-webdrivermanager)
* [Обновили javadoc](#update-javadoc)
...
# Убрали повторные скриншоты и шаги в отчёте для цепочи локаторов {#dedupe-chained-screenshots-report}
...
# Добавили метод $.hover() со сдвигом {#hover-with-offset}
...
# Обновились javadoc многих селенидовских методов {#update-javadoc}
