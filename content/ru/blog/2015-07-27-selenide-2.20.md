...
description: ""
category:
headerText: "Защита от зависания вебдрайвера и стандартное логирование"
tags: []
---
Здрасьте!
...
* [Защита от зависания вебдрайвера](#protection-against-hanging)
* [Логирование переведено на java.util.logging](#jul-logging)
* [Исправили использование Cookies при скачивании файла](#fix-cookies-download)
* [Поддержка коллекций элементов в Page Objects](#element-collections-page-objects)
* [`$("select").shouldHave(text())` проверяет выбранную опцию](#select-shouldhave-selected-option)
* [Скриншот отдельного элемента или региона](#screenshot-of-element)
* [Deprecated методы `$(String, ...)`](#deprecated-string-selector-methods)
* [Удалили зависимость cglib-nodep](#remove-cglib-nodep)
* [Проголосуйте за Selenide на SeleniumConf 2015](#vote-seleniumconf-2015)
* [Новости](#news-links)

## Защита от зависания вебдрайвера при открытии/закрытии браузера {#protection-against-hanging}
...
## Добавили поддержку коллекций элементов в Page Objects {#element-collections-page-objects}
...
## Метод $("select").shouldHave(text("...")) теперь проверяет выбранную опцию {#select-shouldhave-selected-option}
...
## Добавили возможность снять скриншот отдельного элемента или региона {#screenshot-of-element}
...
## Все методы `$(String, ...)` теперь deprecated {#deprecated-string-selector-methods}
...
## Удалили зависимость cglib-nodep из зависимостей Selenide {#remove-cglib-nodep}
...
# Мне нужна ваша помощь! {#vote-seleniumconf-2015}
