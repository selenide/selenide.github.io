...
description: ""
category:
headerText: "Последний день, когда у нас ВСЁ ВСЕРЬЁЗ!"
tags: []
---
...
* [Запускаем кустарные команды](#execute-custom-commands)
* [Дополнили текст ошибки для `shouldHave(attribute("href", ...))`](#improve-href-error-message)
* [Улучшили текст ошибки для OR условий](#improve-or-error-messages)
* [Обновились до WebDriverManager 3.6.2](#upgrade-webdrivermanager)
* [Новости](#news)
* [Конференции](#conferences)

<br/>

# #968 Запускаем кустарные команды {#execute-custom-commands}
...
# #970 Дополнили текст ошибки для `shouldHave(attribute("href", ..."))` {#improve-href-error-message}
...
# #469 Улучшили текст ошибки для OR условий {#improve-or-error-messages}
