---
slug: "selenide-4.11.3"
date: 2018-05-08
title: "Вышла Selenide 4.11.3"
description: ""
category:
headerText: "Проверяем CSS"
tags: []
---

Мы зарелизили Selenide 4.11.3. 

И вот какие новинки вас ждут:

* [Доступ к прокси-серверу](#reveal-selenide-proxy-server)
* [Проверка `cssValue`](#add-css-value-check)
* [Убрали лишнюю зависимость `logback-classic`](#remove-wrong-logback-dependency)
* [Задвоенные скриншоты](#remove-duplicate-screenshots)
* [`browserBinary` при удалённом запуске браузера](#support-browser-binary-for-remote-browser)
* [Новости](#news)
