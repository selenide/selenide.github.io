...
description: ""
category:
headerText: "Мы тебя найдём даже в shadow dom"
tags: []
---
<br>
...
Как вы знаете, в селениде [есть возможность](/2020/03/18/selenide-5.10.0) искать элементы внутри shadow dom. 
...
несколько элементов с искомым локатором. В этом случае придётся вернуться к точечному поиску. 
...
### Добавили метод `page()`, не требующий параметр `Class` {#add-page-without-class}
...
> 
> Документация врёт, комментарии врут, пользователи врут.
> Рано или поздно соврёт и алиас. Локаторы поменяли, а алиас забыли. Или элемент скопировали, а алиас забыли поменять. И т.д.
> 
