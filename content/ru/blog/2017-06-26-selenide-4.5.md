...
description: ""
category:
headerText: "Про-из-во-дительн-ость!"
tags: []
---
Привет, друзья!
...
* [Ускорили `$.setValue()`](#speed-up-setvalue)
* [Ускорили методы работы с коллекциями](#speed-up-collection-methods)
* [Методы `$().$x()` и `$().$$x()`](#added-x-methods)
* [Исправили поддержку Opera driver](#fix-opera-driver)
* [Подчистили лишние логи](#remove-unneeded-logs)
* [Обновились до littleproxy 1.1.2](#upgrade-littleproxy)
* [Обновились до phantomjsdriver 1.4.3](#upgrade-phantomjsdriver)
* [Добавили много юнит-тестов](#added-unit-tests)
* [Новости](#news)
* [Проект `selenide-appium`](#selenide-appium-project)
* [Новые примеры Selenide](#selenide-examples)
* [А ты помог Selenide?](#how-to-help)

<br>

# Ускорили метод `$.setValue()` {#speed-up-setvalue}
...
# Добавили методы `$().$x()` и `$().$$x()` {#added-x-methods}
...
# Обновились до org.littleshoot:littleproxy:1.1.2 {#upgrade-littleproxy}
...
# Добавили много юнит-тестов для самого Selenide {#added-unit-tests}
...
# Мы стартанули проект selenide-appium {#selenide-appium-project}
...
# Мы добавили несколько новых проектов в Selenide examples {#selenide-examples}
