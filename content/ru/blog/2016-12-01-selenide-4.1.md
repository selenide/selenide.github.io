...
description: ""
category:
headerText: "Народное творчество"
tags: []
---
Свершилось!
...
* [Улучшили метод `byAttribute` для поиска через css-селекторы](#improve-by-attribute)
* [Добавили методы `texts(List)` и `exactTexts(List)`](#texts-list)
* [Улучшили поддержку gecko (marionette) драйвера](#gecko-driver-support)
* [Обновили зависимости](#upgraded-dependencies)
* [Новости](#news)

<br/>

# #428 Improve byAttribute method for search via css selectors {#improve-by-attribute}
...
# #419 #425 Added methods `texts(List)` and `exactTexts(List)` {#texts-list}
...
# Improve support for gecko (marionette) driver {#gecko-driver-support}
