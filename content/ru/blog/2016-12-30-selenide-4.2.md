...
description: ""
category:
headerText: "Браузеры и облачные сервисы"
tags: []
---
...
* [Поддержка legacy Firefox driver](#legacy-firefox-driver)
* [Поддержка Microsoft Edge](#microsoft-edge-support)
* [Поддержка https с невалидными сертификатами](#https-invalid-certificates)
* [Кастомные capabilities и облачные сервисы](#custom-capabilities-cloud-services)
* [Прочие изменения](#other-changes)

## Поддержка legacy Firefox driver. [#431](https://github.com/selenide/selenide/issues/431) {#legacy-firefox-driver}
...
## Поддержка Microsoft Edge браузера {#microsoft-edge-support}
...
## Лучшая поддержка https сайтов с невалидными сертификатами. {#https-invalid-certificates}
...
## Поддержка кастомных capabilities и облачных сервисов (BrowserStack, SauceLabs и другие) [#379](https://github.com/selenide/selenide/issues/379) {#custom-capabilities-cloud-services}
