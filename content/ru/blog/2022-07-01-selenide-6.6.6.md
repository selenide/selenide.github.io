...
* [Короткие варианты для `$.click`](#shorter-syntax-for-click)
* [Поддержка мобилок при проверке, жив ли вебдрайвер](#support-mobile-apps-in-webdriver-health-checker)
* [Исправили логику `reopenBrowserOnFail`](#fix-reopen-browser-on-fail)
