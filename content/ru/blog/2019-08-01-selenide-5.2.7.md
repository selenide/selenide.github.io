...
description: ""
category:
headerText: "Аппиум, аппиум - все ошибки сцапаем"
tags: []
---
Всем летний привет!
...
* [Исправили сообщения об ошибках в Selenide+Appium](#fix-error-messages-appium)
* [Метод `open()` без параметров](#open-without-parameters)
* [Метод `because` для коллекций](#because-for-collections)
* [Исправили `open` внутри `open`](#open-inside-open)
* [Новости](#news)
* [Конференции](#conferences)

<br/>

# Подправили сообщения об ошибках при запуске Selenide+Appium {#fix-error-messages-appium}
...
# Добавили метод `open()` без параметров {#open-without-parameters}
...
# Добавили метод `because` для коллекций {#because-for-collections}
...
# Исправили казус с open внутри open {#open-inside-open}
