...
* [Скриншоты внутри `iframe`](#screenshot-inside-iframe)
* [Метод `atBottom()`](#method-at-bottom)
* [Настройка `setValueChangeEvent`](#setting-set-value-change-event)
* [Обновили зависимости](#upgraded-dependencies)
* [Статистика](#statistics)

<br>

# Теперь можно делать скриншоты элементов внутри `iframe` {#screenshot-inside-iframe}
...
# Добавили метод `atBottom()` {#method-at-bottom}
...
# Добавили настройку `setValueChangeEvent` {#setting-set-value-change-event}
