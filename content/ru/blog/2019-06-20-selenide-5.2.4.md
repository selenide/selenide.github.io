...
description: ""
category:
headerText: "Прокси снова в деле"
tags: []
---
Всем привет из лета!
...
* [Исправили прокси на localhost](#fix-proxy-localhost)
* [Исправили `ScreenShooterExtension` для JUnit5](#fix-screenshooter-junit5)
* [Улучшили сообщение об ошибке в `$$.shouldHave(texts(...))`](#improve-texts-error-message)
* [`$.click(offsetX, offsetY)` теперь считает от ЦЕНТРА элемента](#click-offset-center)
* [Обновили зависимости](#updated-dependencies)
* [Новости](#news)
* [Конференции](#conferences)

<br/>

# Исправили работу прокси с приложением на localhost {#fix-proxy-localhost}
...
# Улучшили сообщение об ошибке в `$$.shouldHave(texts("1", "2", "3"))` {#improve-texts-error-message}
...
# Метод `$.click(offsetX, offsetY)` теперь считает координаты от ЦЕНТРА элемента {#click-offset-center}
