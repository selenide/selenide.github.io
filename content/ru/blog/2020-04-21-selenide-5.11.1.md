---
slug: "selenide-5.11.1"
date: 2020-04-21
title: "Вышла Selenide 5.11.1"
description: ""
category:
headerText: "Восстанавливаем устои"
tags: []
---
Всем привет!
...
* [Необязательная зависимость от SLF4J](#optional-slf4j)
* [Исправили `because` с отрицанием](#fix-because-negation)
* [Сбросили 16 мегабайт](#drop-checker-jar)
* [Новости](#news)

## SLF4J {#optional-slf4j} {#optional-slf4j}
...
## because we can! {#fix-because-negation}
