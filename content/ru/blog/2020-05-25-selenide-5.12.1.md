...
description: ""
category:
headerText: "Горячие фиксы к 5.12.0"
tags: []
---
Всем привет!
...
* [Исправили _Concurrent modification exception_ при инициализации вебдрайвера](#fix-concurrent-modification-exception)
* [Исправили мержинг настройки "excludeSwitches" разных типов](#fix-excludeswitches-merging)
* [Новости](#news)
