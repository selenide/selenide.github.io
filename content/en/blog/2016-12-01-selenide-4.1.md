...
* [Improve `byAttribute` method for search via css selectors](#improve-by-attribute)
* [Added methods `texts(List)` and `exactTexts(List)`](#texts-list)
* [Improved support for gecko (marionette) driver](#gecko-driver-support)
