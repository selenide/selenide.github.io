...
description: ""
category:
headerText: "Frames inside frames within frames"
tags: []
---
...
* [Working with inner frames](#inner-frames)
* [PhantomJS supports self-signed certificates](#phantomjs-self-signed-certs)
* [`$.download()` supports self-signed certs](#download-self-signed-certs)
* [`$.setValue()` also triggers `focus` event](#setvalue-triggers-focus)
* [Fixed screenshots bug from Selenide 2.18](#fix-screenshots-bug-2.18)
* [Upgraded to Selenium Webdriver 2.46.0](#upgrade-selenium-2.46.0)
...
## PhantomJS can now work with self-signed certificates {#phantomjs-self-signed-certs}
...
## Method `$.download()` now supports self-signed certs {#download-self-signed-certs}
...
## Method `$.setValue()` also triggers “focus” event {#setvalue-triggers-focus}
...
## Fixed bug with screenshots in Selenide 2.18 {#fix-screenshots-bug-2.18}
...
[Changelog of 2.46.0]({{< selenium-changelog >}}) is quite impressive. 
