...
* [Fixed `IllegalStateException` on closed WebDriver](#fix-illegal-state-exception)
* [Method `close()` always closes the browser](#close-always-closes-browser)
* [Restored short error messages](#restore-short-error-messages)
* [New method `using()` for multiple webdrivers](#add-method-using)
* [Sanity check for XPath](#add-xpath-sanity-check)
