...
description: ""
category:
headerText: "More settings for the Settings God!"
tags: []
---
...
* [Support for `selenide.properties`](#selenide-properties-file)
* [Fine tuning the proxy](#fine-tune-proxy)
* [Workaround for `NoClassDefFoundError`](#workaround-noclassdeffounderror)
* [Changed parameter type of `SelenideConfig.browserCapabilities()`](#browsercapabilities-parameter-type)
* [Upgraded to Selenium WebDriver 4.1.0](#upgrade-selenium-webdriver)
* [Removed `$.shadowRoot()`](#remove-shadow-root)
* [News](#news)
* [Downloads statistics](#statistics)

<br>

# Added support for `selenide.properties` {#selenide-properties-file}
...
# Added possibility for fine tuning the proxy {#fine-tune-proxy}
...
# Added a workaround against random `NoClassDefFoundError` in `WebDriverException`. {#workaround-noclassdeffounderror}
...
# Changed parameter type for method `SelenideConfig.browserCapabilities()` {#browsercapabilities-parameter-type}
...
# Removed method `$.shadowRoot()` {#remove-shadow-root}
