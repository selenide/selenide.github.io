...
* [Flexible checks for collection size](#flexible-collection-size-checks)
* [Speed up of page loading](#page-load-strategy-none)
* [Fixed method `toString()`](#fixed-tostring)
* [Upgraded to selenium-java 2.53.0](#upgrade-selenium-2.53.0)
* [News](#news)
* [Statistics](#statistics)

## We added flexible checks for collection size {#flexible-collection-size-checks}
...
Here is [selenium 2.53.0 changelog]({{< selenium-changelog >}}).
