...
description: ""
category:
headerText: "Reworked waiting algorithm. Forget StaleElementException from now!"
tags: []
---
...
* [Waiting algorithm](#waiting-algorithm)
* [Screenshots](#screenshots)
* [`$.shouldHave(value())` ignores invisible characters](#shouldhave-ignores-invisible-characters)
* [Clicking with JavaScript](#clicking-with-javascript)
* [New method `$.doubleClick()`](#method-doubleclick)
* [Chained `$.hover()`, `$.contextClick()`, `$.dragAndDropTo()`](#chain-hover-contextclick-draganddropto)
* [Fixed Sizzle selectors without jQuery](#fix-sizzle-selectors)
* [New method `WebDriverRunner.hasWebDriverStarted()`](#haswebdriverstarted)
* [`$.setValue()` in fastSetValue mode triggers `input` event](#setvalue-triggers-input-event)
* [Upgraded commons-codec to 1.10](#commons-codec-1.10)
...
## Method `$.shouldHave(value("john"))` now ignores invisible characters (spaces, tabs, newlines). {#shouldhave-ignores-invisible-characters}
...
## Added method `$.doubleClick()` {#method-doubleclick}
...
## Methods `$.hover()`, `$.contextClick()`, `$.dragAndDropTo()` now can be _chained_ {#chain-hover-contextclick-draganddropto}
...
## Fixed Sizzle selectors on pages without jQuery {#fix-sizzle-selectors}

> Thanks to @Gert for this pull request!

## Added method `WebDriverRunner.hasWebDriverStarted()` {#haswebdriverstarted}

It can be useful, say, when you want to take screenshots or perform some other custom actions with webdriver in your tests. 

> Thanks to @dimand58 for this pull request!

## Method `$.setValue()` in `fastSetValue` mode now triggers `input` event {#setvalue-triggers-input-event}
...
## Now Selenide depends on latest version of commons-codec 1.10 {#commons-codec-1.10}
...
## Let me brag {#download-statistics}
