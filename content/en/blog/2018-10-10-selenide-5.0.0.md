...
* [Opening two browsers in a test](#two-browsers-in-test)
* [Chrome is now the default browser](#chrome-by-default)
* [Browser is not maximized by default](#no-maximize-by-default)
* [Browser is not opened automatically](#no-auto-open-browser)
* [Cleaned up unused settings](#cleanup-unused-settings)
* [Removed `junit5-api` dependency](#remove-junit5-api-dependency)
* [Minor changes](#minor-changes)
* [Technical changes](#technical-changes)
* [News](#news)
* [Selenide turns 7](#seven-years-old)
* [How did your upgrade go?](#how-your-upgrade-went)

# You can open two browsers in test {#two-browsers-in-test}
...
When you need to set up environment for test (incl. changing any settings or emulating input from other user),
...
If you still want to use the bad practice, the API looks like this:
...
# Now Selenide uses Chrome by default {#chrome-by-default}
...
Nowadays, this argument is not valid because
1. Firefox now also requires installation of geckodriver, and 
...
# Selenide does *not* maximize browser by default {#no-maximize-by-default}
...
# Selenide doesn't open a browser automatically {#no-auto-open-browser}
...
#### 1. Static fields in page objects
Page object fields were declared static, and browser was closed after every test.
...
#### 2. Test class fields in TestNG
Test class fields (in case of TestNG) were initialized in field declaration, not in `setUp` method. 
...
# Cleaned up unused settings and features {#cleanup-unused-settings}
...
# Removed `junit5-api` api dependency {#remove-junit5-api-dependency}
...
# And minor changes: {#minor-changes}
...
# Technical changes (which probably will not affect you) {#technical-changes}
...
## We get 7 years old! {#seven-years-old}
...
# How your upgrade went? {#how-your-upgrade-went}
