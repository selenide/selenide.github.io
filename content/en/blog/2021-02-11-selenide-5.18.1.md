...
description: ""
category:
headerText: "Localhost is a delicate thing!"
tags: []
---
...
* [Method `Selenide.getSessionStorage()`](#method-getsessionstorage)
* [Fixed error message for `$$.filterBy(and(..))`](#fix-filterby-and-error-message)
* [Pass "noproxy" option to Selenide proxy](#pass-noproxy-option)
* [Updated dependencies](#update-dependencies)

<br>

# Added method `Selenide.getSessionStorage()` {#method-getsessionstorage}
...
# Pass "noproxy" option from user-provided proxy to Selenide proxy {#pass-noproxy-option}
...
# Upgraded to Netty 4.1.59.Final and LittleProxy 2.0.2 {#update-dependencies}
