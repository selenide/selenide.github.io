...
description: ""
category:
headerText: "Marionette, Marathon and again Firefox"
tags: []
---
...
* [Upgraded to Selenium 2.53.1](#upgrade-selenium-2.53.1)
* [Support for Marionette browser](#marionette-support)
* [Support for non-web drivers](#non-web-drivers-support)
* [Removed useless `Screenshots:` message](#remove-useless-screenshots-message)
...
## Added support for Marionette browser {#marionette-support}
...
## Added support for non-web drivers {#non-web-drivers-support}
...
## Removed useless message `Screenshots: ` if screenshots are disabled {#remove-useless-screenshots-message}
...
<center>
  <img src="/images/2016/07/selenide.downloads.png" width="800"/>
</center>

And unique IPs statistics:
<center>
  <img src="/images/2016/07/selenide.unique-ips.png" width="800"/>
</center>
