...
description: ""
category:
headerText: "A gesture of badwill"
tags: []
---
...
* [Shorter syntax for `$.click`](#shorter-syntax-for-click)
* [Support for mobile apps in webdriver health checker](#support-mobile-apps-in-webdriver-health-checker)
* [Fixed `reopenBrowserOnFail` logic](#fix-reopen-browser-on-fail)
