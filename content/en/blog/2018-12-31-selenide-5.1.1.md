...
description: ""
category:
headerText: "Click the transparent"
tags: []
---
...
* [Clicking on transparent elements](#click-transparent-elements)
* [Fixed NPE when proxy is not started](#fix-npe-proxy-not-started)
* [Switching between two webdrivers](#switch-between-webdrivers)
* [Unique folder for every downloaded file](#unique-download-folder)
* [Upgraded to selenium-java 3.141.59](#upgrade-selenium)
* [News](#news)


# Selenide allows clicking on transparent elements {#click-transparent-elements}
...
# Fixed NPE when custom webdriver is run without proxy, but user asks for proxy {#fix-npe-proxy-not-started}
...
# Now you can switch between two webdrivers as many times as you wish {#switch-between-webdrivers}
...
# Selenide generates unique folder for every downloaded file {#unique-download-folder}
...
See selenium 3.141.* [Changelog]({{< selenium-changelog >}})
