...
* [Method `$.as("name")`](#method-as)
* [Default options for headless chrome](#headless-chrome-default-options)
* [Fixed `ByShadowCss.findElements`](#fix-byshadowcss-findelements)
* [`$.should*` methods with custom timeout](#should-with-custom-timeout)
...
# Added method $.as("name") {#method-as}
...
# Added bunch of default options to headless chrome {#headless-chrome-default-options}
...
# Added $.should* methods with custom timeout {#should-with-custom-timeout}
...
# And finally, a couple of technical improvements: {#technical-improvements}
