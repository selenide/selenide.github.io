...
description: ""
category:
headerText: "File upload, select support, webdriver logs"
tags: []
---
...
* [Function `$.uploadFile(File)`](#upload-file)
* [Fixed function `$.uploadFromClasspath`](#fix-upload-from-classpath)
* [Function `$.val()` also works for selects](#val-for-selects)
* [Function `getWebDriverLogs()`](#get-webdriver-logs)
* [Upgraded to Selenium 2.42.2 and HtmlUnit 2.15](#upgrade-selenium-2-42-2)

### Added function $.uploadFile(File) {#upload-file}
...
### Function $.val("john") also works for selects {#val-for-selects}
...
### Added function `getWebDriverLogs()`. {#get-webdriver-logs}
...
### Upgraded to [Selenium 2.42.2]({{< selenium-changelog >}}) and [HtmlUnit 2.15](http://htmlunit.sourceforge.net/changes-report.html#a2.15) {#upgrade-selenium-2-42-2}
