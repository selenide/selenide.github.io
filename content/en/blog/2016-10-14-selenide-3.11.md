...
description: ""
category:
headerText: "The last in 3.x series"
tags: []
---
...
* [Optimized `getMessage()`](#optimize-getmessage)

## Added condition `checked` {#condition-checked}
...
## Optimization of `getMessage()` {#optimize-getmessage}
