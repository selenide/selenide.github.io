---
slug: "selenide-5.12.0"
date: 2020-05-23
title: "Released Selenide 5.12.0"
description: ""
category:
headerText: "The lost capabilities"
tags: []
---
...
* [Fix `Configuration.browserCapabilities`](#fix-browsercapabilities)
* [Disable "save password?" dialog](#disable-save-password-dialog)
* [Mobile emulation mode in grid](#mobile-emulation-in-grid)
* [Simplified Firefox setup without profile](#simplify-firefox-setup)
* [`ACCEPT_INSECURE_CERTS` for Chromium-based Edge](#accept-insecure-certs-edge)
* [Upgraded to WebDriverManager 4.0.0](#upgrade-webdrivermanager)
* [Upgraded to browserup-proxy-core 2.1.0](#upgrade-browserup-proxy)
* [Fixed screenshot folder name 'emptyMethod'](#fix-screenshot-folder-name)
* [`@Nullable`/`@Nonnull` annotations](#nullable-nonnull-annotations)
* [News](#news)

## We fixed an old problem with `Configuration.browserCapabilities` {#fix-browsercapabilities}
...
## We disabled to annoying dialog "save password?" {#disable-save-password-dialog}

See [issue 1133](https://github.com/selenide/selenide/issues/1133) and [PR 1134](https://github.com/selenide/selenide/pull/1134).

## We adeed "mobile emulation" mode in grid {#mobile-emulation-in-grid}
...
## We simplified Firefox setup: now without profile {#simplify-firefox-setup}
...
## We set `"ACCEPT_INSECURE_CERTS"` setting for chromium-based Edge versions {#accept-insecure-certs-edge}
...
## We upgraded to WebDriverManager 4.0.0 {#upgrade-webdrivermanager}
...
## We upgraded to browserup-proxy-core:2.1.0 {#upgrade-browserup-proxy}

Just in case. 


## We fixed name of screenshot folder 'emptyMethod' {#fix-screenshot-folder-name}
...
## Annotated most of the public Selenide methods with `@Nullable` and `@Nonnull` {#nullable-nonnull-annotations}
