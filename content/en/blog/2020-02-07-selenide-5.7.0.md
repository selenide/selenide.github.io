...
* [Added setting `Configuration.downloadsFolder`](#add-downloads-folder-setting)
* [Download files to `Configuration.downloadsFolder` instead of `~/Downloads`](#download-to-downloads-folder)
* [Switching between windows with custom timeout](#switch-window-with-timeout)
* [Logging of "readonly" attribute](#log-readonly-attribute)
* [Fixed `IndexOutOfBoundsException`](#fix-index-out-of-bounds)
* [Several screenshot improvements](#screenshot-improvements)
* [Upgraded to WebDriverManager 3.8.1](#upgrade-webdrivermanager)
* [SeleniumCamp 2020](#seleniumcamp-2020)
* [Meetup about Selenide in Germany](#selenide-meetup-germany)
* [Downloads statistics](#downloads-statistics)
...
### Added method for switching between windows with custom timeout {#switch-window-with-timeout}
...
### Added logging of "readonly" attribute {#log-readonly-attribute}
...
### And several screenshot improvements {#screenshot-improvements}
