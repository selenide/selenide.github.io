...
description: ""
category:
headerText: "To the sound of the salute"
tags: []
---
...
* [Method `$.lastChild()`](#method-lastchild)
* [Collection checks with custom timeout](#collection-checks-with-timeout)
* [Method `Selenide.download(url)`](#method-download)
* [Upgraded to Selenium 3.14.0](#upgrade-selenium)
* [`switchTo().alert()` throws `NoAlertPresentException`](#switchto-alert-exception)
* [Fixed error message from `$.selectOptionByValue()`](#fix-selectoptionbyvalue-error)
* [Fixed name of downloaded file](#fix-downloaded-file-name)
* [Upgraded to WebdriverManager 2.2.5](#upgrade-webdrivermanager)
* [Upgraded to HtmlUnit 2.32.1](#upgrade-htmlunit)
* [Fixed own tests in Firefox](#fix-firefox-tests)
* [News](#news)

<br>

# Added method `$.lastChild()` {#method-lastchild}
...
# Added collection checks with custom timeout {#collection-checks-with-timeout}
...
# Added method `Selenide.download(url)` {#method-download}
...
# Method `switchTo().alert()` now throws `NoAlertPresentException` {#switchto-alert-exception}
...
# Fixed Selenide own tests Firefox {#fix-firefox-tests}
