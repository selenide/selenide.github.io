---
slug: "selenide-4.14.0"
date: 2018-08-29
title: "Released Selenide 4.14.0"
description: ""
category:
headerText: "Judgement day"
tags: []
---
...
* [BasicAuth through proxy](#basicauth-through-proxy)
* [Setting to enable/disable proxy server](#enable-proxy-setting)
* [Removed old IE-specific hack](#remove-ie-hack)
* [News](#news)
* [What do you think?](#what-do-you-think)

<br>

# We implemented BasicAuth through proxy {#basicauth-through-proxy}
...
# We added a dedicated setting to enable/disable proxy server {#enable-proxy-setting}
...
# We removed an old IE-specific hack {#remove-ie-hack}
...
<center>
  <img src="/images/2018/08/selenide.downloads.png" width="800"/>
</center>
