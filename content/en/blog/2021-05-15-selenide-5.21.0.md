---
slug: "selenide-5.21.0"
date: 2021-05-15
title: "Released Selenide 5.21.0"
description: ""
category:
headerText: "Say no to duplicates!"
tags: []
---
...
* [Removed duplicate screenshots for chained locators](#dedupe-chained-screenshots-report)
* [Added `BrowserPerTestStrategyExtension`](#browser-per-test-strategy-extension)
* [Method `$.hover()` with offset](#hover-with-offset)
* [Upgraded to WebDriverManager 4.4.3](#upgrade-webdrivermanager)
* [Updated javadoc](#update-javadoc)
* [`selenide-selenoid` 1.1.2](#selenide-selenoid)
* [`selenide-appium` 1.6.5](#selenide-appium)
* [Links](#links)
* [Statistics](#statistics)

<br>

# We removed duplicate screenshots for chained locators {#dedupe-chained-screenshots-report}
...
# We added BrowserPerTestStrategyExtension {#browser-per-test-strategy-extension}
...
# We added method `$.hover()` with offset {#hover-with-offset}
...
# Updated javadoc of many Selenide methods {#update-javadoc}
