...
description: ""
category:
headerText: "Improvements for Appium and Allure"
tags: []
---
...
* [Fixed error messages in Selenide+Appium](#fix-error-messages-appium)
* [Method `open()` without parameters](#open-without-parameters)
* [Method `because` for collections](#because-for-collections)
* [Fixed `open` inside of `open`](#open-inside-open)
* [News](#news)
* [Conferences](#conferences)

<br/>

# We fixed error messages when running Selenide+Appium {#fix-error-messages-appium}
...
# Added method `open()` without parameters {#open-without-parameters}
...
# Added method `because` for collections {#because-for-collections}
...
# Fixed problem with `open` inside of `open` {#open-inside-open}
