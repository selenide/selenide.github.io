---
slug: "selenide-4.11.2"
date: 2018-04-25
title: "Released Selenide 4.11.2"
description: ""
category:
headerText: "inside frame and at bottom"
tags: []
---
...
* [Screenshots inside `iframe`](#screenshot-inside-iframe)
* [Method `atBottom()`](#method-at-bottom)
* [Setting `setValueChangeEvent`](#setting-set-value-change-event)
* [Upgraded dependencies](#upgraded-dependencies)
* [Statistics](#statistics)

<br>

# Now you can make screenshots inside `iframe` {#screenshot-inside-iframe}
...
# We added method `atBottom()` {#method-at-bottom}
...
# We added setting `setValueChangeEvent` {#setting-set-value-change-event}
...
# We upgraded dependencies {#upgraded-dependencies}
...
<center>
  <img src="/images/2018/04/selenide.downloads.png" width="800"/>
</center>
