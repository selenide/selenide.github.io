...
description: ""
category:
headerText: "Verify CSS"
tags: []
---

We released Selenide 4.11.3. Let's see what updates it contains:

* [Access to proxy server](#reveal-selenide-proxy-server)
* [Condition `cssValue`](#add-css-value-check)
* [Removed wrong dependency `logback-classic`](#remove-wrong-logback-dependency)
* [Removed duplicate screenshots](#remove-duplicate-screenshots)
* [`browserBinary` setting for remote browser](#support-browser-binary-for-remote-browser)
* [News](#news)
