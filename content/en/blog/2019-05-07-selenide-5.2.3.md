...
* [Method `SelenideLogger.beforeEvent()`](#add-before-event-method)
* [Open a blank page](#open-blank-page)
* [Refactoring: `Condition` implementations in separate classes](#refactor-condition-classes)
...
# Added method `SelenideLogger.beforeEvent()` {#add-before-event-method}
...
# Now you can open a blank page {#open-blank-page}
...
# Refactoring: we extracted all `Condition` implementations to separate classes {#refactor-condition-classes}
