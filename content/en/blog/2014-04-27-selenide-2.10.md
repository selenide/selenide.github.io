...
description: ""
category:
headerText: "Windows, tabs, DragAndDrop, JavaScript errors, parent search and upgrade to Selenium 2.41.0"
tags: []
---
...
* [Working with windows and tabs](#windows-tabs)
* [Methods `$.hover()` and `$.dragAndDropTo(target)`](#hover-and-drag-and-drop)
* [Methods `$.parent()` and `$.closest()`](#parent-and-closest)
* [Tracing JavaScript errors](#tracing-javascript-errors)
* [Improved closing of hanging webdrivers](#closing-webdrivers)
* [No more waiting for `<body>`](#no-wait-for-body)
* [Upgraded to Selenium 2.41.0](#upgrade-selenium-2-41-0)
* [Download statistics](#download-statistics)

## New functions

### Working with windows/tabs {#windows-tabs}
...
### New methods `$.hover()` and `$.dragAndDropTo(target)` {#hover-and-drag-and-drop}
...
### New methods for searching parent/ancestors `$.parent()` and `$.closest()` {#parent-and-closest}
...
### Closing webdrivers {#closing-webdrivers}
...
### Selenide does not wait for &lt;body&gt; {#no-wait-for-body}
...
### Upgrade to Selenium 2.41.0 {#upgrade-selenium-2-41-0}
...
## Other news {#download-statistics}
