...
description: ""
category:
headerText: "The beginning of a beautiful friendship"
tags: []
---
...
* [Custom timeout for `switchTo().frame()`](#frame-with-timeout)
* [Selectors `byTagAndText` and `withTagAndText`](#by-tag-and-text)
* [Fixed bug in `byTextCaseInsensitive`](#fix-by-text-case-insensitive)
* [Report records "webdriver create/close"](#report-webdriver-create-close)
* [Fixed overriding of Selenium timeout](#fix-selenium-timeout-override)
* [Removed duplicate wrapping of "Element not found"](#remove-duplicate-element-not-found-wrapping)
* [Support for authentication type `BEARER`](#bearer-auth)
* [Empty settings like `selenide.remote` treated as undefined](#empty-settings-as-undefined)
* [Upgraded to Selenium 4.1.2](#upgrade-selenium-4.1.2)
* [UPD Selenide 6.3.1](#upd-6.3.1)
* [UPD Selenide 6.3.2](#upd-6.3.2)
* [UPD Selenide 6.3.3](#upd-6.3.3)
* [UPD Selenide 6.3.4](#upd-6.3.4)
* [UPD Selenide 6.3.5](#upd-6.3.5)
* [News](#news)

<br>

# Added methods `switchTo().frame(timeout)` with custom timeout {#frame-with-timeout}
