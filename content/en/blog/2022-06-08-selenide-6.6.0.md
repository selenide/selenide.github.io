...
description: ""
category:
headerText: "Deshortcutification of $.clear"
tags: []
---
...
* [New plugin `selenide-clear-with-shortcut`](#selenide-clear-with-shortcut)
* [Fixed `$.clear()` in Safari](#fix-clear-in-safari)
* [New checks for own text](#new-own-test-checks)
* [Method `$.click()` with timeout](#click-timeout)
* [Timeout for `confirm()`, `dismiss()` and `prompt()`](#modal-timeout)
* [Fixed `Driver.executeJavaScript()`](#fix-execute-javascript)
* [Fixed wording of some checks](#fix-checks-wording)
