...
* [Reverted page loading strategy to `normal`](#revert-page-load-strategy)
* [Page objects don't have to be public](#page-objects-not-public)
* [Support for JBrowser webdriver](#jbrowser-support)
* [`$().download()` uses the standard timeout](#download-timeout)
* [Support for Basic Auth](#basic-auth-support)
* [Method `$.screenshotAsImage()`](#method-screenshot-as-image)
* [Fixed TestNG TextReport Listener](#fix-testng-textreport-listener)
* [Upgraded phantomjsdriver to 1.3.0](#upgrade-phantomjsdriver-1.3.0)
* [Other news](#news)
...
## Now page objects don't have to be public {#page-objects-not-public}
...
## Added support for JBrowser webdriver {#jbrowser-support}
...
## Method $().download() now uses the standard selenide timeout {#download-timeout}
...
## Added support for Basic Auth for all common browsers {#basic-auth-support}
...
## Added method `$.screenshotAsImage()` {#method-screenshot-as-image}
...
## Upgraded phantomjsdriver to version 1.3.0 (compatible with selenium-java 2.53.0) {#upgrade-phantomjsdriver-1.3.0}
