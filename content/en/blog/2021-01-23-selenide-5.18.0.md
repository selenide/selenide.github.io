---
slug: "selenide-5.18.0"
date: 2021-01-23
title: "Released Selenide 5.18.0"
description: ""
category:
headerText: "Say no to webdriver logs"
tags: []
---
...
* [Disabled webdriver logs by default](#disable-webdriver-logs)
* [Timeout parameter type: `Long` to `Duration`](#timeout-type-duration)
* [Speed up search of inner shadow dom elements](#speedup-shadow-dom-search)
* [Fixed `$.shouldNot(and(...))` and `$.shouldNot(or(...))`](#fix-shouldnot-and-or)
* [Detect conflict in `browserName` capability](#detect-browsername-conflict)
* [Fixed timeout display in reports](#fix-timeout-display-in-reports)
* [Upgraded to WebDriverManager 4.3.1](#upgrade-webdrivermanager)
* [News](#news)

<br>

# We disabled webdriver logs by default {#disable-webdriver-logs}
...
# Changed "timeout" parameter type from Long to Duration {#timeout-type-duration}
...
# Fixed checks `$.shouldNot(and(...))` and `$.shouldNot(or(...))` {#fix-shouldnot-and-or}
...
# We detect conflict in "browserName" capability {#detect-browsername-conflict}
...
# Fixed displaying timeout parameter in reports {#fix-timeout-display-in-reports}
