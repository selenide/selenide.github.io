---
slug: "selenide-5.14.0"
date: 2020-08-17
title: "Released Selenide 5.14.0"
description: ""
category:
headerText: "Stabilized FOLDER"
tags: []
---
...
* [Stabilized `FOLDER` download mode](#stabilize-folder-mode)
* [Added `itemWithText` collection check](#add-itemwithtext-check)
* [Added Safari browser support](#add-safari-support)
* [Added `SelenideDriver.screenshot(fileName)`](#add-screenshot-filename-method)
* [Added `SelenideDriver.screenshot(OutputType)`](#add-screenshot-outputtype-method)
* [Screenshot on `switchTo()` failure](#screenshot-on-switchto-failure)
* [Added `--disable-dev-shm-usage` chrome option](#add-disable-dev-shm-usage)
* [Fixed Sizzle selectors with Dojo.js/troop.js](#fix-sizzle-selectors)
* [Made `$.toString()` safer](#safer-tostring)
* [Improved error message for disappeared elements](#improve-disappeared-element-error)
* [Upgraded to WebDriverManager 4.1.0](#upgrade-webdrivermanager)
* [News](#news)

## Stabilized new file downloading mode `FOLDER` {#stabilize-folder-mode}
...
## Added check `$$.shouldHave(itemWithText("any text"))` {#add-itemwithtext-check}
...
## Added support for Safari browser {#add-safari-support}
...
## Added method `SelenideDriver.screenshot(fileName)` {#add-screenshot-filename-method}
...
## Added method `SelenideDriver.screenshot(OutputType)` {#add-screenshot-outputtype-method}
...
## Now Selenide takes a screenshot when method `switchTo()` fails {#screenshot-on-switchto-failure}
...
## Added chrome option `--disable-dev-shm-usage` {#add-disable-dev-shm-usage}
...
## Fixed Sizzle selectors on web pages containing Dojo.js, troop.js etc. {#fix-sizzle-selectors}
