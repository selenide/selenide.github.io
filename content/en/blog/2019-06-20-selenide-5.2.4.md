...
description: ""
category:
headerText: "The return of the Proxy"
tags: []
---
...
* [Fixed proxy on localhost](#fix-proxy-localhost)
* [Fixed `ScreenShooterExtension` for JUnit5](#fix-screenshooter-junit5)
* [Improved error message for `$$.shouldHave(texts(...))`](#improve-texts-error-message)
* [`$.click(offsetX, offsetY)` now uses the CENTER of element](#click-offset-center)
...
# We fixed proxy on localhost {#fix-proxy-localhost}
...
# We fixed ScreenShooterExtension for JUnit5 {#fix-screenshooter-junit5}
...
# We improved error message for `$$.shouldHave(texts("1", "2", "3"))` {#improve-texts-error-message}
...
# Method `$.click(offsetX, offsetY)` now calculates coordinates for the CENTER of element {#click-offset-center}
...
# We updated dependencies {#updated-dependencies}
