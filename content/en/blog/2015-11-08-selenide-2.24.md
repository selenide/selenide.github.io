...
* [Upgraded to selenium-java 2.48.2](#upgrade-to-selenium-2.48.2)
* [New method `$.pressEscape()`](#press-escape)
* [Fixed soft asserts for TestNG](#fix-soft-asserts-testng)
* [WebDriverFactory extracted from WebDriverRunner](#webdriverfactory)
* [News](#news)

## Upgraded to selenium-java 2.48.2 {#upgrade-to-selenium-2.48.2}

[changelog of selenium 2.48.2]({{< selenium-changelog >}}).

## Add method `$.pressEscape()` {#press-escape}
...
## Logic of webdriver creation extracted to a separate class WebDriverFactory {#webdriverfactory}
