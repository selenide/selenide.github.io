...
description: ""
category:
headerText: "Soft asserts, hard iterators"
tags: []
---
...
* [Link "&lt;Click to see difference&gt;" for more assertion errors](#assertion-error-diff-link)
* [Replaced `$$.iterator()`](#replace-iterator)
* [Fixed `SoftAssert` to avoid failing a test](#softassert-no-fail-when-disabled)
* [Fixed soft asserts to include all the errors](#softassert-merge-errors)
* [Added locator to some assertion errors](#assertion-error-locator)
* [Upgraded BrowserUpProxy from 2.1.2 to 2.1.3](#upgrade-browserupproxy)
* [Upgraded TestNG from 7.4.0 to 7.5](#upgrade-testng)

<br>

# Added link "&lt;Click to see difference&gt;" for most of Selenide assertion errors {#assertion-error-diff-link}
...
# Replaced `$$.iterator()` by `$$.asDynamicIterable()` and `$$.asFixedIterable()` {#replace-iterator}
...
# We fixed soft asserts to include all the errors {#softassert-merge-errors}
...
# We added locator to some of Selenide assertion errors {#assertion-error-locator}
