---
slug: "selenide-5.12.1"
date: 2020-05-25
title: "Released Selenide 5.12.1"
description: ""
category:
headerText: "Hot fixes for 5.12.0"
tags: []
---
...
* [Fix _Concurrent modification exception_ during webdriver init](#fix-concurrent-modification-exception)
* [Fix merging of "excludeSwitches" settings of different types](#fix-excludeswitches-merging)
* [News](#news)

## Fixed _Concurrent modification exception_ during webdriver initialization {#fix-concurrent-modification-exception}

See [issue 1170](https://github.com/selenide/selenide/issues/1170) and [PR 1171](https://github.com/selenide/selenide/pull/1171).

## Fixed merging of "excludeSwitches" settings of different types {#fix-excludeswitches-merging}
