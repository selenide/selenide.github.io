...
* [Generate random file name for downloaded file](#random-file-name)
* [Fixed `IndexOutOfBounds` when parent not found](#fix-indexoutofbounds-parent-not-found)
* [Fixed `ClassCastException` in `$$.toArray()`](#fix-classcastexception-toarray)
* [Support for Chrome 70](#support-chrome-70)
* [Upgraded to selenium-java 3.141.5](#upgrade-selenium)
...
# Fixed `IndexOutOfBounds` when parent element is not found {#fix-indexoutofbounds-parent-not-found}
...
# Fixed `ClassCastException` in method `$$.toArray()` {#fix-classcastexception-toarray}
...
# Added support for chrome 70 {#support-chrome-70}
...
[Changelog]({{< selenium-changelog >}}) of selenium 3.141.*

<br>

## Selenide download statistics {#download-statistics}
