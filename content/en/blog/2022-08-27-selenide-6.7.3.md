...
* [Condition `partialValue`](#condition-partial-value)
* [Condition `tagName`](#condition-tag-name)
* [Check that element is `<select>`](#check-select-tag)
