...
description: ""
category:
headerText: "Pseudo-elements, pseudo-navigation, pseudo-conditions"
tags: []
---
...
* [Custom conditions using lambdas](#custom-conditions-lambdas)
* [Methods `$.sibling()` and `$.preceding()`](#sibling-and-preceding)
* [Support for pseudo-elements](#pseudo-elements-support)
* [Fixed `SoftAssertionsExtension` for JUnit5](#fix-soft-assertions-junit5)
* [`$.click()` always clicks in the CENTER of an element](#click-center)
* [News](#news)

## Simplified creation of custom conditions using lambdas {#custom-conditions-lambdas}
...
## Added methods `$.sibling()` and `$.preceding()` {#sibling-and-preceding}
...
## Added support for pseudo-elements  {#pseudo-elements-support}
...
## Now `$.click()` always clicks in the CENTER of an element  {#click-center}
