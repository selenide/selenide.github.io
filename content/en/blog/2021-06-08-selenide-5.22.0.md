---
slug: "selenide-5.22.0"
date: 2021-06-08
title: "Released Selenide 5.22.0"
description: ""
category:
headerText: "Wake up, we have a release again!"
tags: []
---
...
* [Close an alert to download a file](#close-alert-before-download)
* [Improved condition `textCaseSensitive`](#improve-text-case-sensitive)
* [Selectors `byTextCaseInsensitive` and `withTextCaseInsensitive`](#case-insensitive-selectors)
* [Method `Driver.getSessionId()`](#get-session-id)
* [Shortened default webdriver timeouts](#shorten-webdriver-timeouts)
* [`selenide-selenoid` 1.1.3](#selenide-selenoid)
* [`selenide-appium` 1.6.6](#selenide-appium)
* [News](#news)

<br>

# Now you can close an alert to download a file {#close-alert-before-download}
...
# We improved condition `textCaseSensitive` {#improve-text-case-sensitive}
...
# We added selectors `byTextCaseInsensitive` and `withTextCaseInsensitive` {#case-insensitive-selectors}
...
That's why we had to write [a tricky JS code](https://github.com/selenide/selenide/blob/master/src/main/resources/find-elements-by-text.js) to walk through the DOM tree.
...
# We added method `Driver.getSessionId()` {#get-session-id}
...
# We shortened default webdriver timeouts {#shorten-webdriver-timeouts}
