...
* [Selenide profiler for TestNG](#testng-profiler)
* [Methods `$$.first()` and `$$.last()`](#first-last)
* [Method `Screenshots.getLastScreenshot()`](#get-last-screenshot)
* [Parameterless `confirm()` and `dismiss()`](#confirm-dismiss-no-params)
* [Option `-Dselenide.reopenBrowserOnFail`](#reopen-browser-on-fail)
* [Upgraded to htmlunit 2.19](#htmlunit-2.19)
* [Changed license to MIT](#mit-license)
* [News](#news)

## We added "Selenide profiler" for TestNG {#testng-profiler}
...
## We added methods `$$.first()` and `$$.last()` {#first-last}
...
## We added method `Screenshots.getLastScreenshot()` {#get-last-screenshot}
...
## We added methods Selenide.confirm() and Selenide.dismiss() {#confirm-dismiss-no-params}
...
## We added option `-Dselenide.reopenBrowserOnFail` {#reopen-browser-on-fail}
...
## Changed Selenide license MIT {#mit-license}
