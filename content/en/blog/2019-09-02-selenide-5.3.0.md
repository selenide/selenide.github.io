...
description: ""
category:
headerText: "Execute custom commands"
tags: []
---

We released Selenide 5.3.0. What's new?

* [Execute custom commands](#execute-custom-commands)
* [Improved error message for `shouldHave(attribute("href", ...))`](#improve-href-error-message)
* [Improved error messages for OR checks](#improve-or-error-messages)
* [Upgraded to WebDriverManager 3.6.2](#upgrade-webdrivermanager)
* [News](#news)
* [Conferences](#conferences)

<br/>

# #968 Execute custom commands {#execute-custom-commands}
...
# #970 Improved error message for `shouldHave(attribute("href", ..."))` {#improve-href-error-message}
...
# #469 Improved error messages for OR checks {#improve-or-error-messages}
