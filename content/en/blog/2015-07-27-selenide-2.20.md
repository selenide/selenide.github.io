...
description: ""
category:
headerText: "Protection against webdriver hanging and standard logging"
tags: []
---
...
* [Protection against webdriver hanging](#protection-against-hanging)
* [Standard logging via java.util.logging](#jul-logging)
* [Fixed Cookies usage when downloading file](#fix-cookies-download)
* [Element collections in Page Objects](#element-collections-page-objects)
* [`$("select").shouldHave(text())` checks the selected option](#select-shouldhave-selected-option)
* [Screenshot of one element or region](#screenshot-of-element)
* [Deprecated `$(String, ...)` methods](#deprecated-string-selector-methods)
* [Removed cglib-nodep dependency](#remove-cglib-nodep)
* [Vote for Selenide at SeleniumConf 2015](#vote-seleniumconf-2015)
...
## Selenide now uses java.util.logging for logging {#jul-logging}
...
## Added support for element collections to Page Objects {#element-collections-page-objects}
...
## Method $("select").shouldHave(text("...")) now checks the selected option {#select-shouldhave-selected-option}
...
## Added method for taking screenshot of one element or region {#screenshot-of-element}
...
## All methods `$(String, ...)` made deprecated {#deprecated-string-selector-methods}
...
## Removed cglib-nodep from Selenide dependencies {#remove-cglib-nodep}
...
# I need your help! {#vote-seleniumconf-2015}
