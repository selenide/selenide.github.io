...
* [Speed up `$.setValue()`](#speed-up-setvalue)
* [Speed up collection methods](#speed-up-collection-methods)
* [Methods `$().$x()` and `$().$$x()`](#added-x-methods)
* [Fix support for Opera driver](#fix-opera-driver)
* [Remove unneeded logs](#remove-unneeded-logs)
* [Upgraded to littleproxy 1.1.2](#upgrade-littleproxy)
* [Upgraded to phantomjsdriver 1.4.3](#upgrade-phantomjsdriver)
* [Added lots of unit-tests](#added-unit-tests)
* [News](#news)
* [Project `selenide-appium`](#selenide-appium-project)
* [New Selenide examples](#selenide-examples)
* [How can YOU help Selenide?](#how-to-help)

<br>

# Speed up method `$.setValue()` {#speed-up-setvalue}
...
# Added methods `$().$x()` and `$().$$x()` {#added-x-methods}
...
# Upgraded to org.littleshoot:littleproxy:1.1.2 {#upgrade-littleproxy}
...
# Added lots of unit-tests for Selenide itself {#added-unit-tests}
...
# We started project `selenide-appium` {#selenide-appium-project}
...
# We added more projects to Selenide examples {#selenide-examples}
