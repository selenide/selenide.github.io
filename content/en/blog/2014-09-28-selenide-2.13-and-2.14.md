---
slug: "selenide-2.13-and-2.14"
date: 2014-09-28
title: "Changes in 2.13 and 2.14"
description: ""
category:
headerText: "Fast setValue, image check, custom error messages, upgrade to Selenium 2.43.1"
tags: []
---
...
* [Fast method `$.setValue`](#fast-set-value)
* [Checking images `$("img").isImage()`](#is-image-check)
* [Custom messages for asserts](#custom-assert-messages)
* [Wrappers `be` and `have`](#be-and-have-wrappers)
* [Upgraded to Selenium 2.43.1](#upgrade-selenium-2-43-1)
...
### Added method for checking images `$("img").isImage()` {#is-image-check}
...
### Added possibility to add descriptions to asserts (like in JUnit and TestNG asserts) {#custom-assert-messages}
...
### Added wrappers `be` and `have`. {#be-and-have-wrappers}
...
### Upgraded to [Selenium 2.43.1]({{< selenium-changelog >}}). {#upgrade-selenium-2-43-1}
