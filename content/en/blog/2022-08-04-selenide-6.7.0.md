...
description: ""
category:
headerText: "Full texts, full screenshots"
tags: []
---
...
* [`$.shouldHave(text)` can verify the whole text](#holy-whole-string)
...
* [Returned `String` parameter for `$.setValue()`](#restore-set-value-string)
* [Warning about invalid file extension](#validate-file-extension)
