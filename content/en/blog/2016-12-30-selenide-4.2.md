...
description: ""
category:
headerText: "Browsers and cloud services"
tags: []
---
...
* [Support of legacy Firefox driver](#legacy-firefox-driver)
* [Microsoft Edge support](#microsoft-edge-support)
* [Better support for https sites with invalid certificates](#https-invalid-certificates)
* [Custom capabilities and cloud services (BrowserStack, SauceLabs etc.)](#custom-capabilities-cloud-services)
* [Other changes](#other-changes)

## Support of legacy Firefox driver. [#431](https://github.com/selenide/selenide/issues/431) {#legacy-firefox-driver}
...
## Better support for https site with invalid certificates. {#https-invalid-certificates}
...
##  Support of custom capabilities and cloud services (BrowserStack, SauceLabs etc.) [#379](https://github.com/selenide/selenide/issues/379) {#custom-capabilities-cloud-services}
