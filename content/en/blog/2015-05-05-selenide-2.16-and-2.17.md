...
description: ""
category:
headerText: "Profiler, Soft asserts and few improvements"
tags: []
---
...
* [Profiler](#profiler)
* [Fixed function `$.closest()`](#fix-closest)
* [Method `$.toString()` now logs all attributes](#tostring-all-attributes)
* [Upgraded to Selenium 2.45.0](#upgrade-selenium)
...
### Upgraded to [Selenium 2.45.0]({{< selenium-changelog >}}). {#upgrade-selenium}
