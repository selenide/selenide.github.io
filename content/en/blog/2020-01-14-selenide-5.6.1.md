...
description: ""
category:
headerText: "Proxy is getting smarter"
tags: []
---
...
* [Added method `Selenide.executeAsyncScript()`](#add-execute-async-script)
* [Download files without `Content-Disposition` header](#download-without-content-disposition)
* [Fix method `WebDriverRunner.using()`](#fix-webdriverrunner-using)
* [Upgraded to WebDriverManager 3.8.0](#upgrade-webdrivermanager)
* [News](#news)
...
# Now Selenide can download files without `Content-Disposition` header (via proxy) {#download-without-content-disposition}
