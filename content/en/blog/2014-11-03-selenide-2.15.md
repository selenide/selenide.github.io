...
description: ""
category:
headerText: "Sizzle selectors, multifile upload, BrowserMob proxy, zoom, Selenium 2.44.0"
tags: []
---
...
* [Sizzle selectors (CSS3)](#sizzle-selectors)
* [Multifile upload](#multifile-upload)
* [Support for BrowserMob proxy](#browsermob-proxy)
* [Zoom page](#zoom-page)
* [Support for JSON and iCal](#json-and-ical)
* [Support for tabs and windows by index](#tabs-and-windows-by-index)
* [Support for Allure Framework](#allure-framework)
* [Upgraded to Selenium 2.44.0](#upgrade-selenium-2-44-0)
...
### You can zoom page now! {#zoom-page}
...
### Support for tabs and windows/tabs {#tabs-and-windows-by-index}
...
### Upgraded to [Selenium 2.44.0]({{< selenium-changelog >}}). {#upgrade-selenium-2-44-0}
