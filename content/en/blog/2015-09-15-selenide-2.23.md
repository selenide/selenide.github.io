...
* [New method `$.selectRadio()`](#method-selectradio)
* [`$.setValue()` now handles radio buttons](#setvalue-radio-buttons)
* [Cannot set value to readonly field](#no-set-value-readonly)
* [`$.setValue()` takes `maxlength` into account](#setvalue-maxlength)
* [Fixed unclosed FireFox instances](#fix-unclosed-firefox)
* [News](#news)
...
## Method `$.setValue()` can now handle radio buttons {#setvalue-radio-buttons}
...
## You cannot set value to readonly field {#no-set-value-readonly}
...
## Method `$.setValue()` takes attribute `maxlength` into account {#setvalue-maxlength}
...
## Fixed issue with unclosed FireFox instances {#fix-unclosed-firefox}
...
<center>
  <img src="/images/2015/09/test-driver-java-development.2015.jpg">
</center>
...
<center>
  <img src="/images/2015/09/selenide_downloads.png" width="800"/>
</center>
