---
slug: "selenide-5.23.0"
date: 2021-07-16
title: "Released Selenide 5.23.0"
description: ""
category:
headerText: "New generation checks"
tags: []
---
...
* [New generation checks](#new-generation-checks)
* [Checks for URL](#checks-for-url)
* [Checks for clipboard](#checks-for-clipboard)
* [Checks for `localStorage`](#checks-for-local-storage)
* [Checks for `sessionStorage`](#checks-for-session-storage)
* [A small refactoring](#small-refactoring)
* [Bugfix: `Selenide.screenshot()` with disabled screenshots](#screenshot-with-screenshots-disabled)
* [`selenide-selenoid` 1.1.4](#selenide-selenoid)
* [`selenide-appium` 1.6.7](#selenide-appium)
* [New links](#links)
* [Statistics](#statistics)

# The new generation checks {#new-generation-checks} {#new-generation-checks}
...
# And a small bugfix: {#screenshot-with-screenshots-disabled}
